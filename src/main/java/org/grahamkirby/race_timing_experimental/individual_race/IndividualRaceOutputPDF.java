...
public class IndividualRaceOutputPDF {
    ...
    private final class PrizeResultPrinter extends ResultPrinter {
        ...
        @Override
        public void printResult(final IndividualRaceResult r) throws IOException {
    ...
    protected PrizeWinnerDetails getPrizeWinnerDetails(final IndividualRaceResult result) {
