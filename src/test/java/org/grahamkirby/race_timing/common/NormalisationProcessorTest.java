...
public class NormalisationProcessorTest {
    ...
    @FuzzTest
    void fuzzGetNameOfRunner(@NotNull final String s) {

        try {
            NormalisationProcessor.getFirstNameOfRunner(s);
            NormalisationProcessor.getLastNameOfRunner(s);
        }
    ...
    @FuzzTest
    void fuzzParseTime(@NotNull final String time) {

        try {
            NormalisationProcessor.parseTime(time);
        }
