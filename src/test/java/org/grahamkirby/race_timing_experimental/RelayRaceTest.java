...
public class RelayRaceTest extends AbstractRaceTest {
    ...
    private static final Object[][] TESTS_EXPECTED_TO_GIVE_ERROR = new Object[][] {
        ...
        new Object[] {"relay_race/duplicate_team_number", (Function<AbstractRaceTest, String>) race_test -> STR."duplicate bib number '3' at line 4 in file '\{race_test.getFileNameForPathProperty(KEY_ENTRIES_PATH)}'"},
        ...
        new Object[] {"relay_race/illegal_category", (Function<AbstractRaceTest, String>) race_test -> STR."invalid category in entry '3 Team 3 Men Senior Jackbruce Martin King & Leland Donaldson Neil MacDonald & Myles  Christie Hubert Gray' at line 3 in file '\{race_test.getFileNameForPathProperty(KEY_ENTRIES_PATH)}'"},
