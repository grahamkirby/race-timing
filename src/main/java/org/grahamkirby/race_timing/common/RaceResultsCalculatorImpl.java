...
public abstract class RaceResultsCalculatorImpl implements RaceResultsCalculator {

    protected Race race;
    protected List<RaceResult> overall_results;
    protected final StringBuilder notes;

    protected RaceResultsCalculatorImpl() {
    ...
    protected boolean arePrizesInOtherCategorySameAge(final PrizeCategory category) {
    ...
    protected void setPrizeWinners(final PrizeCategory category) {
    ...
    protected String getClub(RaceResult result) {
        return ((Runner) result.getParticipant()).club;
    }

    protected static boolean isStillEligibleForPrize(final RaceResult result, final PrizeCategory new_prize_category) {
    ...
    protected void setPositionStrings(final List<RaceResult> results) {
