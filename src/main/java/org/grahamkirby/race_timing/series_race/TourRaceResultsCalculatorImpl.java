...
public class TourRaceResultsCalculatorImpl implements RaceResultsCalculator {
    ...
    public Duration getRunnerTime(final Race race, final Runner runner) {
    ...
    protected List<Comparator<RaceResult>> getComparators() {
        ...
        return List.of(TourRaceResultsCalculatorImpl::comparePossibleCompletion, TourRaceResultsCalculatorImpl::comparePerformance, TourRaceResultsCalculatorImpl::compareRunnerLastName, TourRaceResultsCalculatorImpl::compareRunnerFirstName);
    }
