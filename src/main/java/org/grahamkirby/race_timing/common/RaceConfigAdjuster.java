...
public class RaceConfigAdjuster extends ConfigProcessor {
    ...
    public static String DEFAULT_CAPITALISATION_STOP_WORDS_PATH = DEFAULT_CONFIG_ROOT_PATH.resolve("capitalisation_stop_words." + FILE_SUFFIX_CSV).toString();
    public static String DEFAULT_NORMALISED_HTML_ENTITIES_PATH = DEFAULT_CONFIG_ROOT_PATH.resolve("html_entities." + FILE_SUFFIX_CSV).toString();
    public static String DEFAULT_NORMALISED_CLUB_NAMES_PATH = DEFAULT_CONFIG_ROOT_PATH.resolve("club_names." + FILE_SUFFIX_CSV).toString();
